        ...
        <div className="login-body">
            <div className="login-body__form">
                ...
                <div className="login-body__input mb-16">
                    <input onChange={onEmailChanged} type="text" placeholder="Email or phone number" />
                </div>
                <div className="login-body__input">
                    <input onChange={onPasswordChanged} type="password" placeholder="Password" />
                </div>
                <button onClick={login} className="login-body__submit-btn">Sign In</button>
